			...
			<ModalBody>
				<>
					...
					<p>
						...
						distanza non sono obbligatorii per la visuazzione dei dati. È infatti possibiie immediatamente dopo aver 
						...
						dimensioni da applicare agli assi, dimensione da utilizzare per l'applicazione del colore sui punti ecc. <br/>
